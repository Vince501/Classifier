...
public class classifer2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classifer);
        ...
        try {
            ...
            for(int i = 0; i < imageSize; i ++){
                for(int j = 0; j < imageSize; j++){
                    ...
                    byteBuffer.putFloat(((val >> 16) & 0xFF) * (1.f / 1));// already divided by 255
